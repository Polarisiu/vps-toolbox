...
execute_choice() {
    case "$1" in
        1) bash <(curl -sL https://raw.githubusercontent.com/iu683/vps-tools/main/update.sh) ;;
        2) bash <(curl -fsSL https://raw.githubusercontent.com/iu683/vps-tools/main/vpsinfo.sh) ;;
        3) sudo passwd root ;;
        4) bash <(curl -sL https://raw.githubusercontent.com/iu683/unblock/main/miyao.sh) ;;
        5) bash <(curl -sL https://raw.githubusercontent.com/iu683/unblock/main/sshdk.sh) ;;
        ...
        8) bash <(curl -sL https://raw.githubusercontent.com/iu683/vps-tools/main/open_all_ports.sh) ;;
        9) bash <(curl -sL https://raw.githubusercontent.com/iu683/unblock/main/xgmim.sh) ;;
        10) bash <(curl -sL https://raw.githubusercontent.com/iu683/unblock/main/huanyuan.sh) ;;
        11) bash <(curl -fsSL https://raw.githubusercontent.com/iu683/vps-tools/main/debian.sh) ;;
        12) bash <(curl -fsSL https://raw.githubusercontent.com/iu683/vps-tools/main/window.sh) ;;
        13) sudo reboot ;;
        14) bash <(curl -fsSL https://raw.githubusercontent.com/iu683/proxy/main/proxy.sh) ;;
        ...
        20) bash <(curl -sL https://raw.githubusercontent.com/iu683/proxy/main/3xui.sh) ;;
        ...
        22) bash <(curl -fsSL https://raw.githubusercontent.com/iu683/proxy/main/Reality.sh) ;;
        23) bash <(curl -sL https://raw.githubusercontent.com/iu683/proxy/main/Realm.sh) ;;
        24) bash <(curl -sL https://raw.githubusercontent.com/iu683/proxy/main/gost.sh) ;;
        ...
        28) bash <(curl -sL https://raw.githubusercontent.com/iu683/vps-tools/main/media_dns.sh) ;;
        29) bash <(wget -qO- https://raw.githubusercontent.com/mocchen/cssmeihua/mochen/shell/ddns.sh) ;;
        30) bash <(curl -sL https://raw.githubusercontent.com/iu683/vps-tools/main/tun2socks.sh) ;;
        ...
        33) bash <(curl -fsSL https://raw.githubusercontent.com/iu683/unblock/main/ipcheck.sh) ;;
        ...
        37) bash <(curl -sL https://raw.githubusercontent.com/iu683/unblock/main/sentt.sh) ;;
        38) bash <(curl -sL https://raw.githubusercontent.com/iu683/unblock/main/Telnet.sh) ;;
        39) bash <(curl -sL https://raw.githubusercontent.com/iu683/vps-tools/main/Docker.sh) ;;
        ...
        42) curl -fsSL https://raw.githubusercontent.com/iu683/app-store/main/vpsdocker.sh -o vpsdocker.sh && chmod +x vpsdocker.sh && ./vpsdocker.sh ;;
        43) bash <(curl -sL https://raw.githubusercontent.com/iu683/app-store/main/Panel.sh) ;;
        44) bash <(curl -sL https://raw.githubusercontent.com/iu683/app-store/main/nezha.sh) ;;
        45) bash <(curl -fsSL https://raw.githubusercontent.com/iu683/app-store/main/ytdlb.sh) ;;
        46) bash <(curl -fsSL https://raw.githubusercontent.com/1keji/AddIPv6/main/manage_nginx_v6.sh) ;;
        47) bash <(curl -sL https://raw.githubusercontent.com/iu683/app-store/main/nginx.sh) ;;
        48) bash <(curl -sL https://raw.githubusercontent.com/iu683/unblock/main/qlxt.sh) ;;
        49) bash <(curl -fsSL https://raw.githubusercontent.com/iu683/unblock/main/restore.sh) ;;
        50) bash <(curl -fsSL https://raw.githubusercontent.com/iu683/unblock/main/beifen.sh) ;;
        51) bash <(curl -sL https://raw.githubusercontent.com/iu683/unblock/main/reinstall.sh) ;;
        52) bash <(curl -sL https://raw.githubusercontent.com/iu683/unblock/main/zujian.sh) ;;
        53) bash <(curl -sL https://raw.githubusercontent.com/iu683/unblock/main/cjia.sh) ;;
        54) wget https://www.moerats.com/usr/shell/swap.sh && bash swap.sh ;;
        55) bash <(curl -fsSL https://raw.githubusercontent.com/iu683/unblock/main/dns.sh) ;;
        56) bash <(curl -fsSL https://raw.githubusercontent.com/iu683/unblock/main/tmux.sh) ;;
        57) bash <(curl -fsSL https://raw.githubusercontent.com/iu683/unblock/main/System.sh) ;;
        ...
        63) bash <(curl -fsSL https://raw.githubusercontent.com/iu683/unblock/main/oracle.sh) ;;
        64) bash <(curl -fsSL https://raw.githubusercontent.com/iu683/unblock/main/azpve.sh) ;;
        65) bash <(curl -fsSL https://raw.githubusercontent.com/iu683/unblock/main/jsyzl.sh) ;;
        66) bash <(curl -fsSL https://raw.githubusercontent.com/iu683/unblock/main/ipef.sh) ;;
        88)
